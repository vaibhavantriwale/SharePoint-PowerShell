#-----------------------------------------------------------------------------------------------------------
#	Name 		: Taxomony_Column_Update_Site_Collection.ps1
#	Description : The script will remove all the orphaned values from Taxonomy fields(Both single and multi)
#	Usage		: Run this script and provide Site collection URL when requested in Powershell window
